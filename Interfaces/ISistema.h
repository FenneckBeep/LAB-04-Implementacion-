...
public:
    ...
    virtual Status existeUsuario(std::string nickname, std::string contrasenia,
                                 std::string nombre, std::string email) = 0;

    virtual Status altaUsuario_Cliente(std::string apellido, std::string documento) = 0;
    virtual Status altaUsuario_Propietario(std::string cuentaBancaria,
                                           std::string telefono) = 0;
    virtual Status altaUsuario_Inmobiliaria(std::string direccion, std::string telefono,
                                            std::string url) = 0;
    ...
    virtual Status agregarPropietario(std::string nickname) = 0;
    virtual Status agregarInmueble(std::string direccion, std::string numPuerta,
                                   int superficie, int anioConstruccion) = 0;
    virtual int agregarCasa(bool esHorizontal, TipoTecho techo) = 0;
    virtual int agregarApartamento(int numPiso, bool tieneAscensor,
                                   double gastosComunes) = 0;
    virtual Status representarPropietario(std::string nicknameInmobiliaria,
                                          std::string nicknamePropietario) = 0;
